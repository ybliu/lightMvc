...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'west',border:false,split:true" title="字典类别" style="width:200px;overflow-y: scroll; ">
