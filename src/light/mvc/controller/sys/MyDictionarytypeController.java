...
@Controller
@RequestMapping("/mydictionarytype")
public class MyDictionarytypeController extends BaseController {

	@Autowired
	private DictionarytypeServiceI dictionarytypeService;
	
	@Autowired
	private MyDictionaryTypeServiceI mYdictionarytypeService;
	...
	public List<Tree> tree(HttpSession session) {
		return mYdictionarytypeService.tree();
	}
